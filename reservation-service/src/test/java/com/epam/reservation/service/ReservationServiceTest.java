...
class ReservationServiceTest {
	...
	void addReservationTest() {
		User user = new User();
		user.setStatus(true);
		user.setUserName("Sunkudinesh9");
		user.setPassword("test");
		List<CreditCard> creditCards = new ArrayList<>();
		creditCards.add(new CreditCard(1, 1234567890, "12/24", "Sunku Dinesh Kumar", "Visa"));
		user.setCreditCards(creditCards);
		user.setProfile(new Profile(1, "Dinesh kumar", "Sunku", "sunku.dinesh9@gmail.com", 9176060361L, "Gandhi katta",
				"Tadipatri", "Andhra Pradesh", 515411, "India"));
