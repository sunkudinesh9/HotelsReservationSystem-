...
class ReservationControllerTest {
	...
	void addReservationTest() throws Exception {
		...
		Mockito.when(reservationService.addReservation(reservationDto)).thenReturn(reservationUtility.convert(reservationDto));
	...
	void cancelReservationTest() throws Exception {
		...
		Mockito.when(reservationService.cancelReservation(ArgumentMatchers.any(ReservationDto.class), ArgumentMatchers.anyInt()))
				.thenReturn(reservationUtility.convert(reservationDto));
